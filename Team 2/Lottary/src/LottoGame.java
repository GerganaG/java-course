...
//	private JTable table;
	...
	private void initialize() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < 5; i++) {
					...
					try {
						...
						num = numberFormat.parse(table_2.getValueAt(i, 0).toString()).intValue();
		...
		btnExport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					FileWriter third = new FileWriter("third.txt");
					...
					for (int i = 0; i < rowT; i++) {
						String rowElements3 = String.format("%s : %s numbers", table_3.getValueAt(i, 0),
		...
		Object[][] rowData3 = new Object[0][2];
		Object[] colum3 = { "Winnig player", "Winning numbers" };
